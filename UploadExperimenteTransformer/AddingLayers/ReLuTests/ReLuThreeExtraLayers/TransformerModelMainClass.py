...
def create_model_and_functions(model_type_transformer, optimizer_type, num_training_steps, num_of_classes):
    model = DistilBertExtensionFirstVersion.from_pretrained(model_type_transformer, num_of_classes= num_of_classes)
...
def evaluate_model(eval_dataloader):
    ...
    print("Three Extra ReLu Layers Result")
...
Recall: 0.919
f1_score: 0.919
matthews_corrcoef: 0.8374091968162656
"""
print(dataset_final)
...
Recall: 0.803
f1_score: 0.803
matthews_corrcoef: 0.644458839420349
"""
print(dataset_final)
