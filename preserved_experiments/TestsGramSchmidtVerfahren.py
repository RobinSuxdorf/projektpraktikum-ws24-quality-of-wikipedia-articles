...
cat_list, label_list = add_list_to_other_list(
    cat_list, label_list, cat2_list, label_list_2
)
...
X_train, X_test, Y_train, Y_test = train_test_split(
    scalar_products_final, label_list, test_size=0.2, random_state=42
)
...
X_train, X_test, Y_train, Y_test = train_test_split(
    encoded_vector, label_list, test_size=0.2, random_state=42
)
