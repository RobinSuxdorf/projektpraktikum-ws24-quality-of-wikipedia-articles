...
execute_all_methods(classification_type, model_type, promotional_path, augmented_promotional_path, neutral_path, good_path, amount_of_entries, preprocess_data_flg, batch_size, model_config, num_epochs, save_file_path, load_trained_model_flg)
...
#load_trained_model_flg means whether one wants to evaluate a pretrained model wiwthout further training.
load_trained_model_flg = 0
execute_all_methods("multilabel_normal", model_type, promotional_path, augmented_promotional_path, neutral_path, good_path, amount_of_entries, preprocess_data_flg, batch_size, model_config, num_epochs, save_file_path, load_trained_model_flg)
