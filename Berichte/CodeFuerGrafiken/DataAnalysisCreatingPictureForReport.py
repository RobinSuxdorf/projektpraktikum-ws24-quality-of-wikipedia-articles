...
promo_path= "ErsteVersuche/Daten/promotional.csv"
good_path = "ErsteVersuche/Daten/good.csv"
...
df_aggreg.plot(kind= 'barh', title= 'Verteilung der Kategorien', ylabel = 'Kategorien', xlabel = 'Anzahl Artikel pro Klasse')
plt.show()