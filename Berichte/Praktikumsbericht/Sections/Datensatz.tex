...
%Erter Satz geändert
Als Basis wurde ein Datensatz verwendet, welcher  verschiedene Wikipedia-Artikel enthält \cite{UrsprungDatensatz}. Der Datensatz wurde in zwei Dateien unterteilt. Die erste Datei enthielt gute Artikel und die zweite enthielt %\emph{promotional} (
...
\begin{itemize} \item Die Verwendung des ursprünglichen Datensatzes zur binären Klassifizierung
...
\item Eine Multilabelklassifizierung, welche gute von werbenden Artikeln unterscheidet und in den werbenden Artikeln zwischen den verschiedenen Arten (advert, coi, fanpov, pr, resume) unterscheiden kann. 
\end{itemize}
